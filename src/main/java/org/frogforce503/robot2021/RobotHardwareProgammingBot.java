...
public class RobotHardwareProgammingBot extends RobotHardware {
    ...
    public void initializeConstants() {
        ...
        kModulePositions = new Translation2d[]{kVehicleToBackRight
                , kVehicleToBackLeft, kVehicleToFrontLeft,
        ...
        FrogPIDF multiuseheadingPID = new FrogPIDF(0.005, 0.0, 0.0, 0.0, ControlMode.Position_Control);
        stabilizationPID = new FrogPIDF(0.005, 0.0, 0.0, 0.0, ControlMode.Position_Control);
        autuonomousAnglePID = multiuseheadingPID;
        snappingPID = multiuseheadingPID;
        visionAnglePID = multiuseheadingPID;

        kSwerveModuleGearRatio = (12.0 / 40.0) * (20.0 / 40.0);
    }
}
