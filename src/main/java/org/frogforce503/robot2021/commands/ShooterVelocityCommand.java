...
public class ShooterVelocityCommand extends CommandBase {
    ...
    double mShooterVelocity;

    /**
     * Creates a new ShooterVelocityCommand.
     */
    public ShooterVelocityCommand(double shooterVelocity) {
        // Use addRequirements() here to declare subsystem dependencies.
        this.mShooterVelocity = shooterVelocity;
    }

    // Called when the command is initially scheduled.
    @Override
    public void initialize() {
        Shooter.getInstance().setVelocity(this.mShooterVelocity);
    }
